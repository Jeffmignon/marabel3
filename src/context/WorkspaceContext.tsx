...
1. [Anthropic — Engineering Notes](https://anthropic.com)`,
  ...
  },
  {
    ...
    sourceActivity: [],
    sources: [
      { id: "src-nl2-1", type: "url", name: "InfoQ", detail: "infoq.com", url: "https://infoq.com", itemCount: 5, syncedAgo: "30m ago" },
      { id: "src-nl2-2", type: "url", name: "GitHub Blog", detail: "github.blog", url: "https://github.blog", itemCount: 2, syncedAgo: "3h ago" },
    ],
    suggestedSources: [
      { id: "sug-nl2-1", type: "url", name: "AWS Blog", detail: "aws.amazon.com/blogs", reason: "Matches cloud infra topic" },
    ],
    approvalQueue: [],
    reviewers: [
      { id: "r-nl2-1", name: "Riley Chen", email: "riley@acmecorp.com", role: "Reviewer", isAdmin: false, step: 1 },
      { id: "r-nl2-2", name: "Sam Lee", email: "sam@acmecorp.com", role: "Editor", isAdmin: true, step: 2 },
    ],
    issues: [
      {
        id: "iss-nl2-1",
...
## Cloud cost is now an architectural problem

FinOps teams are owning 30%+ of platform decisions in 2026. The line between SRE and finance is blurring fast.[1]

The winners are treating cost as a first-class architectural concern, not a quarterly review.

---

## Sources

1. [InfoQ — FinOps Patterns](https://infoq.com)`,
      },
      { id: "iss-nl2-2", name: "Issue #4", status: "published", date: "Apr 18, 2026" },
      { id: "iss-nl2-3", name: "Issue #3", status: "published", date: "Apr 11, 2026" },
      { id: "iss-nl2-4", name: "Issue #2", status: "published", date: "Apr 4, 2026" },
    ],
    skills: [],
  ...
  },
  {
    ...
    sourceActivity: [],
    sources: [
      { id: "src-nl3-1", type: "url", name: "First Round Review", detail: "review.firstround.com", url: "https://review.firstround.com", itemCount: 1, syncedAgo: "4h ago" },
      { id: "src-nl3-2", type: "url", name: "Stratechery", detail: "stratechery.com", url: "https://stratechery.com", itemCount: 2, syncedAgo: "1d ago" },
    ],
    suggestedSources: [],
    approvalQueue: [],
    reviewers: [
      { id: "r-nl3-1", name: "Jordan Patel", email: "jordan@acmecorp.com", role: "Editor", isAdmin: true, step: 1 },
    ],
    issues: [
      {
        id: "iss-nl3-1",
        ...
        date: "Apr 24, 2026",
        approvalStep: 0,
        content: `## What the best founders do in week 2 of a downturn

The instinct is to cut. The discipline is to choose what to *not* cut.[1]

In the cohort we tracked across 2022–2024, the founders who came out ahead held three things sacred during a contraction: their top decile of customers, the engineering team's velocity on the riskiest product bet, and their own weekly cadence with the board.

---

## Sources

1. [First Round Review — Crisis Playbooks](https://review.firstround.com)`,
      },
      { id: "iss-nl3-2", name: "Issue #17", status: "published", date: "Apr 17, 2026" },
      { id: "iss-nl3-3", name: "Issue #16", status: "published", date: "Apr 10, 2026" },
      { id: "iss-nl3-4", name: "Issue #15", status: "published", date: "Apr 3, 2026" },
    ],
    skills: [],
    schedule: { frequency: "weekly", dayOfWeek: "Thursday", time: "07:00", timezone: "America/New_York", active: true },
  },
  {
    id: "nl-4",
    name: "Brand Beat",
    ...
    sourceActivity: [],
    sources: [
      { id: "src-nl4-1", type: "url", name: "Modern Retail", detail: "modernretail.co", url: "https://modernretail.co", itemCount: 3, syncedAgo: "2h ago" },
      { id: "src-nl4-2", type: "url", name: "Glossy", detail: "glossy.co", url: "https://glossy.co", itemCount: 2, syncedAgo: "5h ago" },
      { id: "src-nl4-3", type: "url", name: "Retail Dive", detail: "retaildive.com", url: "https://retaildive.com", itemCount: 4, syncedAgo: "30m ago" },
    ],
    suggestedSources: [
      { id: "sug-nl4-1", type: "url", name: "Business of Fashion", detail: "businessoffashion.com", reason: "DTC and luxury overlap" },
    ],
    approvalQueue: [],
    reviewers: [
      { id: "r-nl4-1", name: "Morgan Wu", email: "morgan@acmecorp.com", role: "Reviewer", isAdmin: false, step: 1 },
      { id: "r-nl4-2", name: "Jane Doe", email: "jane@acmecorp.com", role: "Editor", isAdmin: false, step: 2 },
    ],
    issues: [
      {
        id: "iss-nl4-1",
        ...
        date: "Apr 23, 2026",
        approvalStep: 0,
        content: `## DTC margin math is breaking

Shipping is up. Returns are up. CAC is up. The 70%-gross-margin DTC model that 2018 made famous is, charitably, on life support.[1][2]

The brands still profitable are the ones who moved hard into wholesale, repriced their CAC budget against second-order LTV (referrals + reorders, not first-order revenue), and stopped pretending the customer "owns their data" line was anything but a brittle storyline.

---

## Sources

1. [Modern Retail — CAC 2026](https://modernretail.co)
2. [Glossy — DTC Margins Decline](https://glossy.co)`,
      },
      { id: "iss-nl4-2", name: "Issue #7", status: "published", date: "Apr 16, 2026" },
      { id: "iss-nl4-3", name: "Issue #6", status: "published", date: "Apr 9, 2026" },
    ],
    skills: [],
    schedule: { frequency: "weekly", dayOfWeek: "Wednesday", time: "08:00", timezone: "America/New_York", active: true },
  },
  {
    id: "nl-5",
    ...
    sourceActivity: [],
    sources: [
      { id: "src-nl5-1", type: "url", name: "Canary Media", detail: "canarymedia.com", url: "https://canarymedia.com", itemCount: 6, syncedAgo: "20m ago" },
      { id: "src-nl5-2", type: "url", name: "Heatmap News", detail: "heatmap.news", url: "https://heatmap.news", itemCount: 3, syncedAgo: "1h ago" },
    ],
    suggestedSources: [
      { id: "sug-nl5-1", type: "url", name: "Cleantech Group", detail: "cleantech.com", reason: "Strong on financing and policy" },
    ],
    approvalQueue: [],
    reviewers: [
      { id: "r-nl5-1", name: "Casey Diaz", email: "casey@acmecorp.com", role: "Editor", isAdmin: true, step: 1 },
    ],
    issues: [
      {
        id: "iss-nl5-1",
        ...
        date: "Apr 26, 2026",
        approvalStep: 0,
        content: `## Heat pumps just hit price parity. Now what?

The crossover happened quietly this quarter: in 14 U.S. states, the installed cost of a new heat pump is lower than a new gas furnace.[1]

The constraint stops being unit economics and starts being installer capacity. The trade is roughly 18 months out from a real shortage.

---

## Sources

1. [Canary Media — Heat Pump Parity 2026](https://canarymedia.com)`,
      },
      { id: "iss-nl5-2", name: "Issue #13", status: "published", date: "Apr 19, 2026" },
      { id: "iss-nl5-3", name: "Issue #12", status: "published", date: "Apr 12, 2026" },
    ],
    skills: [],
    schedule: { frequency: "weekly", dayOfWeek: "Sunday", time: "09:00", timezone: "America/New_York", active: true },
  },
  {
    id: "nl-6",
    name: "Talent Wire",
    ...
    sourceActivity: [],
    sources: [
      { id: "src-nl6-1", type: "url", name: "Lattice Blog", detail: "lattice.com/library", url: "https://lattice.com/library", itemCount: 2, syncedAgo: "6h ago" },
      { id: "src-nl6-2", type: "url", name: "Recruiting Brainfood", detail: "recruitingbrainfood.com", url: "https://recruitingbrainfood.com", itemCount: 1, syncedAgo: "1d ago" },
    ],
    suggestedSources: [],
    approvalQueue: [],
    reviewers: [
      { id: "r-nl6-1", name: "Taylor Kim", email: "taylor@acmecorp.com", role: "Reviewer", isAdmin: false, step: 1 },
      { id: "r-nl6-2", name: "Sam Lee", email: "sam@acmecorp.com", role: "Editor", isAdmin: true, step: 2 },
    ],
    issues: [
      {
        id: "iss-nl6-1",
        ...
        date: "Apr 27, 2026",
        approvalStep: 0,
        content: `## Why your top hires are leaving in 18 months

The exit-interview data this quarter looks the same across our portfolio: the people you over-recruited for in 2024 are now mid-tenure, and "growth opportunity" is the line item that's failing them.[1]

The cheapest fix is also the most uncomfortable: tell them, on the record, what the next two years look like. Not the company's — *theirs*.

---

## Sources

1. [Lattice — Mid-Tenure Attrition](https://lattice.com/library)`,
      },
      { id: "iss-nl6-2", name: "Issue #5", status: "published", date: "Apr 20, 2026" },
      { id: "iss-nl6-3", name: "Issue #4", status: "published", date: "Apr 13, 2026" },
    ],
    skills: [],
    schedule: { frequency: "weekly", dayOfWeek: "Monday", time: "09:00", timezone: "America/New_York", active: true },
  },
];
